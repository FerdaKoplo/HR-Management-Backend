...
namespace hr_management_backend.Migrations
{
    ...
    [Migration("20250904142746_AddTimestampsToEmployees")]
    partial class AddTimestampsToEmployees
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("hr_management_backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 9, 4, 14, 27, 44, 727, DateTimeKind.Utc).AddTicks(96),
                            Email = "admin@example.com",
                            Name = "admin",
                            Password = "$2a$11$yeoFtOlqLdNvAUvuO4OA2e3vfY4/Wrph7DWwfRSzGR2CuhLKBLROu",
                            Role = 0
                        });
                });
